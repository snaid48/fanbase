        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="content">
                        <form role="form" action="/news/update" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="news_title" value="{{$news->news_title}} " class="form-control" id="inputEmail3" placeholder="News Title">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea rows="5" name="news_field"  class="form-control" placeholder="News Field" value="">{{$news->news_field}}</textarea>
                                </div>
                            </div>
