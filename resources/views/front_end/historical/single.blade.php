    ...
    <div class="row">
      <div class="span12">
        <ul class="breadcrumb notop">
          ...
          <li class="active">Single Historical</li>
        </ul>
      </div>
    </div>
  </div>
      ...
      <div class="span12" style="text-align: center">
        ...
        <article class="blog-post">
          <div class="post-heading">
            <h1><a href="#">{{ $historical->historical_title}}</a></h1>
          </div>
          <div class="clearfix">
          </div>
          <img src="{{asset('/storage/historical/'.$historical->photo)}}" alt="" />
          <ul class="post-meta">
            ...
            aria-controls="collapseExample">
                            ...
                            <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"> 
                                ...
                                <div class="modal-body">
                                        <center>
                                            <form action="/rating_historical/store" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div id="rateYo" data-rateyo-rating="0"></div>
                                            {{-- <input type="hidden" value="1" name="rateyoid" id="rateyoid"> --}}
                                            <input type="hidden" value="{{ $historical->id}} " name="historical_id">
            ...
            <div class="card card-body">
              ...
              <form role="form" action="/historical/comment" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name="author" value="{{ Auth::user()->id}} "> {{-- <input type="hidden" name="posting"
                    value="1"> --}}
        ...
        <ul class="media-list" style="text-align: left">
          @isset($historical) @forelse($historical->comment_historical as $row)
          <li class="media">
        ...
        <aside>
          ...
          <div class="widget">
            ...
            <ul class="cat">
              ...
              <li><a href="#">Internet historical (15)</a></li>
